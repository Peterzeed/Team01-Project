class Non_SJF:
    ...
    def processData(self, no_of_processes):
        ...
        Non_SJF.schedulingProcess(self, process_data)
    ...
    def schedulingProcess(self, process_data):
        ...
        t_time = Non_SJF.calculateTurnaroundTime(self, process_data)
        w_time = Non_SJF.calculateWaitingTime(self, process_data)
        Non_SJF.printData(self, process_data, t_time, w_time)
